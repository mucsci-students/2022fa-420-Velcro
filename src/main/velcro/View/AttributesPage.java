...
public class AttributesPage {
	...
	public AttributesPage(Instance thisInstance) {
		...
		// Initial pane setup.
		attributesPage.setTitle("Velcro CSCI 420 :: Fields");
		...
		attributesPage.getContentPane().add(lblReturnType);
		
		JComboBox<String> comboBox_1_1 = new JComboBox<String>((ComboBoxModel) null);
		comboBox_1_1.setEditable(true);
		comboBox_1_1.setBounds(58, 162, 255, 51);
		attributesPage.getContentPane().add(comboBox_1_1);
